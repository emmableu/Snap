...
IDE_Morph.prototype.fixLayout = function (situation) {
    ...
    if (situation !== 'refreshPalette') {
        ...
        if (this.isEmbedMode) {
            ...
            this.stage.setScale(Math.floor(Math.min(
                this.logo.width()*3 / this.stage.dimensions.x,
                (this.height() - this.controlBar.height() * 2 - padding * 2)
                / this.stage.dimensions.y
            ) * 10) / 10);
...
//below was kind of made for non-parsons problem
// extend(IDE_Morph, 'createLogo', function(base) {
//     base.call(this);
//     this.logo.hide();
// });
...
//             // console.log(this.isSmallStage, this.stageRatio);
//             this.stage.setScale(Math.floor(Math.min(
//                 this.logo.width()*2.5 / this.stage.dimensions.x,
//                 (this.height() - this.controlBar.height() * 2 - padding * 2)
//                 / this.stage.dimensions.y
//             ) * 10) / 10);
//             // instruction_width = this.logo.width()*2.5 / this.stage.dimensions.x;
//
//
